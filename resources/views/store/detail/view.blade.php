        ...
        <div class="container">
            ...
            <div class="row col-12 align-items: center; display: flex; justify-content: center;">
                ...
                <div class="form-group">
                    <!-- 왼쪽 -->
                    <img src="{{ $product->url_of_illustration }}" style="max-width: 100%; height: auto;"
                        onclick="openModal();currentSlide(1)" class="hover-shadow cursor">
                </div>
                <!-- 오른쪽 -->
                <div class="form-group col-8">
                    <div class="title" name="illustration_title"
                        style="width:100%; text-align:center; margin:30px; background-color:lightgray;">
                    ...
                    <div class="introduce" name="introduction_of_illustration"
                        style="width:100%; height:150px; margin:30px; background-color:lightgray;">
                    ...
                    <div class="price" name="price_of_illustration"
                        style="width:100%; margin:30px; background-color:lightgray;">
                            ...
                            <button type="button" style="margin:10px;"><img src="{{asset('image/store/hand.png')}}"
                                ...
                                <button type="button" style="margin:10px;"><img src="{{asset('image/store/like.png')}}"
                                    ...
                                    <button type="button" style="margin:10px;"><img
                                            src="{{asset('image/store/share.png')}}" style="width:40px; height:40px;">
                                        <button type="button" style="margin:10px;"><img
                                                src="{{asset('image/store/warning.png')}}"
                                                style="width:40px; height:40px;">
                    </div>
                    <hr style="width:100%;">
                </div>
