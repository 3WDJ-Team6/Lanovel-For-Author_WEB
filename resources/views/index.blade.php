                ...
                <div class="form-group" style=" border-radius: 15px; box-shadow: 0px 0px 13px -5px rgba(0, 0, 0, 5);">
                    <div class="post-preview" style="width:100%; height:250px; margin-bottom:4%;">
                        <div class="form-group"
                            style=" border-radius: 15px; box-shadow: 0px 0px 13px -7px rgba(0, 0, 0, 5);">
                            <div class="post-preview" style="width:100%; height:250px; margin-bottom:3%;">
                                <div class="form-group"
                                    ...
                                    <a href="{{url('editor/main/chapter')}}/{{$post['num']}}"
                                        ...
                                        <div class="post-title"
                                            style="width:450px; margin-top:30px; margin-bottom:30px; display:inline-flex; color:black; font-size:1.75rem">

                                            {{ $post->work_title }}
                                            <button type="button"
                                                style="margin-left:1%;display:inline-block; border: none; background-color:white; height:30px;">
                                                <img src="{{asset('image/edit.png')}}"
                                                    style="cursor:pointer; display:inline-block; height:30px;"></button>
                                            <button type="button"
                                                style="display:inline-block; border: none; background-color:white; height:30px;">
                                ...
                                <div class="side-group"
                                    ...
                                    <p class="post-meta"
                                        style="display:inline-block; margin-bottom:0;width:350px; font-style:italic; color:#868e96; font-size:16px;">
